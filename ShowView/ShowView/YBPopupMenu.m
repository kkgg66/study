                        ...
                        delegate:(id<YBPopupMenuDelegate>)delegate
{
    if (self = [super init]) {
        ...
        showView.height+=kArrowHeight;
        showView.width+=kArrowWidth;
        self.width = showView.width;
        self.height = showView.height;
        ...
        _contentView =showView;
        _contentView.centerY = _mainView.centerY;
        _contentView.centerX =_mainView.centerX;
...
- (void)dismiss
{
    [UIView animateWithDuration: 0.25 animations:^{
        ...
        _contentView.height-=kArrowHeight;
        _contentView.width-=kArrowWidth;
        self.delegate = nil;
...
+ (instancetype)showRelyOnView:(UIView *)view
                      ...
                      delegate:(id<YBPopupMenuDelegate>)delegate
{
    YBPopupMenu *popupMenu = [[YBPopupMenu alloc] initWithshowView:showView delegate:delegate];
